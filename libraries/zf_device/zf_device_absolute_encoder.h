...
#define ABSOLUTE_ENCODER_SPI                (SPI_3)                             // 硬件 SPI 号
#define ABSOLUTE_ENCODER_SCLK_PIN           (SPI3_SCLK_P02_7)                  // 硬件 SPI SCK 引脚
#define ABSOLUTE_ENCODER_MOSI_PIN           (SPI3_MOSI_P02_6)                  // 硬件 SPI MOSI 引脚
#define ABSOLUTE_ENCODER_MISO_PIN           (SPI3_MISO_P02_5)                  // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define ABSOLUTE_ENCODER_CS_PIN             (P02_4)                            // CS引脚定义
